...
I'm a web developer finishing my BSIT (major in **Web and Mobile Technologies**) at **PSU San Carlos**, graduating July 2026, with a strong interest in building systems that solve real problems.

* 💼 Completed an **Internship at [Outsoar PH](https://github.com/outsoarph)*, working on the Cooper Web App (Laravel, Filament, Node.js)
* 🧩 Full-stack developer working across frontend and backend, with a focus on **backend development and system design**
* 🏗️ Interested in **clean architecture and scalable applications**
* 🤝 Continuously improving through real-world projects and team-based collaboration
...
<p>
  <img src="https://skillicons.dev/icons?i=laravel,php,react,nodejs,flutter,dart,html,css,js,tailwind,mysql,postgres,sqlite,docker,git,github,vite,java,kotlin,cs,cpp,python" />
</p>
...
<p>
  <img src="https://skillicons.dev/icons?i=postman,wordpress" />
</p>
...
* Building more **real-world backend systems**
* Learning **Docker and deployment workflows**
* Improving **code structure and scalability**
* Gaining experience in **team-based development**
